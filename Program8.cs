    ...
    internal class Program
    {
        ...
        static void SymulujGrupe(int druzyna1, int druzyna2, int druzyna3, int druzyna4)
        {
            ...
            if (wspolczynnik1 > wspolczynnik2)
            {
                ...
                Console.WriteLine($"Wygrana druzyny {dr1}\n");
                punkty1 += 3;
            }
            else
            {
                ...
                Console.WriteLine($"{dr1} vs {dr2}");
                Console.WriteLine($"Wygrana druzyny {dr2}\n");
                punkty2 += 3;
            }
            ...
            else
            {
                ...
                Console.WriteLine($"{dr1} vs {dr3}");
                Console.WriteLine($"Wygrana druzyny {dr3}\n");
                punkty3 += 3;
            }
            ...
            else
            {
                ...
                Console.WriteLine($"{dr1} vs {dr4}");
                Console.WriteLine($"Wygrana druzyny {dr4}\n");
                punkty4 += 3;
            }
            ...
            /*
            Console.WriteLine("\nTabela punktow");
            if (punkty1 > punkty2 && punkty1 > punkty3 && punkty1 > punkty4 && punkty2 < punkty1 && punkty2 > punkty3 
                && punkty2 > punkty4 && punkty3 < punkty1 && punkty3 < punkty2 && punkty3 > punkty4 && punkty4 < punkty1
                && punkty4 < punkty2 && punkty4 < punkty3)
            {
                Console.WriteLine($"{dr1} {punkty1}");
                Console.WriteLine($"{dr2} {punkty2}");
                Console.WriteLine($"{dr3} {punkty3}");
            ...
            else if (punkty1 < punkty2 && punkty1 > punkty3 && punkty1 > punkty4)
            {
                Console.WriteLine($"{dr2} {punkty2}");
                Console.WriteLine($"{dr2} {punkty2}");
                Console.WriteLine($"{dr3} {punkty3}");
