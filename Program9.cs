...
namespace Sym_MS2022
{
    internal class Program
    {
        ...
        static void SymulujGrupe(int druzyna1, int druzyna2, int druzyna3, int druzyna4)
        {
            ...
            {
                //1,2
                if (punkty1 > punkty2 && punkty1 > punkty3 && punkty1 > punkty4)
                {
                    Console.WriteLine($"Awans druzyny {dr1}");
                    if (!(punkty1 > punkty2 && punkty2 > punkty3 && punkty2 > punkty4))
                    {
                    ...
                    {
                        Console.WriteLine($"Awans druzyny {dr2}");
                    }
                }
            }
            ...
            {
                //2,1
                if (punkty2 > punkty1 && punkty2 > punkty3 && punkty2 > punkty4)
                {
                    Console.WriteLine($"Awans druzyny {dr2}");
                    if (!(punkty2 > punkty1 && punkty1 > punkty3 && punkty1 > punkty4))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr1}");
                    if (!(punkty1 > punkty3 && punkty3 > punkty2 && punkty3 > punkty4))
                    {
                    ...
                    {
                        Console.WriteLine($"Awans druzyny {dr3}");
                    }
                }
            }
            ...
            {
                //3,1
                if (punkty3 > punkty1 && punkty3 > punkty2 && punkty3 > punkty4)
                {
                    Console.WriteLine($"Awans druzyny {dr3}");
                    if (!(punkty3 > punkty1 && punkty1 > punkty2 && punkty1 > punkty4))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr1}");
                    if (!(punkty1 > punkty4 && punkty4 > punkty2 && punkty4 > punkty3))
                    {
                    ...
                    {
                        Console.WriteLine($"Awans druzyny {dr4}");
                    }
                }
            }
            ...
            {
                //4,1
                if (punkty4 > punkty1 && punkty4 > punkty2 && punkty4 > punkty3)
                {
                    Console.WriteLine($"Awans druzyny {dr4}");
                    if (!(punkty4 > punkty1 && punkty1 > punkty2 && punkty1 > punkty3))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr2}");
                    if (!(punkty2 > punkty3 && punkty3 > punkty1 && punkty3 > punkty4))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr3}");
                    if (!(punkty3 > punkty2 && punkty2 > punkty1 && punkty2 > punkty4))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr2}");
                    if (!(punkty2 > punkty4 && punkty4 > punkty1 && punkty4 > punkty3))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr4}");
                    if (!(punkty4 > punkty2 && punkty2 > punkty1 && punkty2 > punkty3))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr3}");
                    if (!(punkty3 > punkty4 && punkty4 > punkty1 && punkty4 > punkty2))
                    {
            ...
            while (CzyKontynuowac)
            {
                ...
                {
                    Console.WriteLine($"Awans druzyny {dr4}");
                    if (!(punkty4 > punkty3 && punkty3 > punkty1 && punkty3 > punkty2))
                    {
